...
CREATE TABLE "tbl_Racks" (
    ...
    CONSTRAINT "FK_Racks_Freezers"
        FOREIGN KEY ("FreezerID") REFERENCES "tbl_Freezers" ("FreezerID")
);
...
CREATE TABLE "tbl_Boxes" (
    ...
    CONSTRAINT "FK_Boxes_Racks"
        FOREIGN KEY ("RackID") REFERENCES "tbl_Racks" ("RackID")
);
...
CREATE TABLE "tbl_Approvals" (
    ...
    CONSTRAINT "FK_Approvals_EDApprover"
        FOREIGN KEY ("EDApproverUserId") REFERENCES "AspNetUsers" ("Id"),
    CONSTRAINT "FK_Approvals_RegulatoryApprover"
        FOREIGN KEY ("RegulatoryApproverUserId") REFERENCES "AspNetUsers" ("Id"),
    CONSTRAINT "FK_Approvals_PIApprover"
        FOREIGN KEY ("PIApproverUserId") REFERENCES "AspNetUsers" ("Id")
);
...
CREATE TABLE "tbl_Specimens" (
    ...
    CONSTRAINT "FK_Specimens_Studies"
        FOREIGN KEY ("StudyID") REFERENCES "tbl_Studies" ("StudyID"),
    CONSTRAINT "FK_Specimens_SampleTypes"
        FOREIGN KEY ("SampleTypeID") REFERENCES "tbl_SampleTypes" ("SampleTypeID"),
    CONSTRAINT "FK_Specimens_Boxes"
        FOREIGN KEY ("BoxID") REFERENCES "tbl_Boxes" ("BoxID"),
    CONSTRAINT "FK_Specimens_DiscardApproval"
        FOREIGN KEY ("DiscardApprovalID") REFERENCES "tbl_Approvals" ("ApprovalID")
);
...
CREATE TABLE "tbl_ShipmentBatches" (
    ...
    CONSTRAINT "FK_ShipmentBatches_ImportedBy"
        FOREIGN KEY ("ImportedByUserId") REFERENCES "AspNetUsers" ("Id"),
    CONSTRAINT "FK_ShipmentBatches_Approval"
        FOREIGN KEY ("ApprovalID") REFERENCES "tbl_Approvals" ("ApprovalID")
);
...
CREATE TABLE "tbl_ShipmentRequests" (
    ...
    CONSTRAINT "FK_ShipmentRequests_Batch"
        FOREIGN KEY ("BatchID") REFERENCES "tbl_ShipmentBatches" ("BatchID"),
    CONSTRAINT "FK_ShipmentRequests_SampleType"
        FOREIGN KEY ("RequestedSampleTypeID") REFERENCES "tbl_SampleTypes" ("SampleTypeID"),
    CONSTRAINT "FK_ShipmentRequests_Specimen"
        FOREIGN KEY ("MatchedSpecimenID") REFERENCES "tbl_Specimens" ("SpecimenID")
);
...
CREATE TABLE "tbl_Shipments" (
    ...
    CONSTRAINT "FK_Shipments_ShippedBy"
        FOREIGN KEY ("ShippedByUserId") REFERENCES "AspNetUsers" ("Id"),
    CONSTRAINT "FK_Shipments_ShippedBox"
        FOREIGN KEY ("ShippedBoxID") REFERENCES "tbl_Boxes" ("BoxID")
);
...
CREATE TABLE "tbl_ShipmentContents" (
    ...
    CONSTRAINT "FK_ShipmentContents_Shipment"
        FOREIGN KEY ("ShipmentID") REFERENCES "tbl_Shipments" ("ShipmentID"),
    CONSTRAINT "FK_ShipmentContents_Specimen"
        FOREIGN KEY ("SpecimenID") REFERENCES "tbl_Specimens" ("SpecimenID")
);
