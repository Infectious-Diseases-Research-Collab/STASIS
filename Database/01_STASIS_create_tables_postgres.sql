...
ALTER TABLE IF EXISTS ONLY public."tbl_Racks" DROP CONSTRAINT IF EXISTS "FK_Racks_Compartments";
ALTER TABLE IF EXISTS ONLY public."tbl_Compartments" DROP CONSTRAINT IF EXISTS "FK_Compartments_Freezers";
...
ALTER TABLE IF EXISTS ONLY public."tbl_Compartments" DROP CONSTRAINT IF EXISTS "PK_Compartments";
...
DROP TABLE IF EXISTS public."tbl_VisitTypes";
...
--
-- Name: tbl_Compartments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."tbl_Compartments" (
    "CompartmentID" integer NOT NULL,
    "CompartmentName" character varying(100) NOT NULL,
    "Description" character varying(500),
    "FreezerID" integer NOT NULL
);
...
--
-- Name: tbl_Compartments_CompartmentID_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public."tbl_Compartments" ALTER COLUMN "CompartmentID" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."tbl_Compartments_CompartmentID_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tbl_Compartments PK_Compartments; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."tbl_Compartments"
    ADD CONSTRAINT "PK_Compartments" PRIMARY KEY ("CompartmentID");
...
--
-- Name: tbl_Compartments UQ_Compartments_FreezerCompartment; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."tbl_Compartments"
    ADD CONSTRAINT "UQ_Compartments_FreezerCompartment" UNIQUE ("FreezerID", "CompartmentName");
...
--
-- Name: tbl_Compartments FK_Compartments_Freezers; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."tbl_Compartments"
    ADD CONSTRAINT "FK_Compartments_Freezers" FOREIGN KEY ("FreezerID") REFERENCES public."tbl_Freezers"("FreezerID") ON DELETE RESTRICT;


--
-- Name: tbl_Racks FK_Racks_Compartments; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."tbl_Racks"
    ADD CONSTRAINT "FK_Racks_Compartments" FOREIGN KEY ("CompartmentID") REFERENCES public."tbl_Compartments"("CompartmentID") ON DELETE RESTRICT;
